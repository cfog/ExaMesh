...
void LagrangeCubicTetMapping::setModalValues() {
	...
	for (int ii = 0; ii < 3; ii++) {
		...
		Cww[ii] = 4.5
				* (2 * c[0][ii] - c[3][ii] - 5 * c[10][ii] + 4 * c[11][ii]);

		Cuv[ii] = 4.5
				* (4 * c[0][ii] - 5 * c[4][ii] + c[5][ii] - c[6][ii] - c[7][ii]
						+ c[8][ii] - 5 * c[9][ii] + 6 * c[16][ii]);
		Cvw[ii] =
				4.5
						* (4 * c[0][ii] - 5 * c[9][ii] + c[8][ii] - c[14][ii]
								- c[15][ii] + c[11][ii] - 5 * c[10][ii]
								+ 6 * c[19][ii]);
		Cuw[ii] =
				4.5
						* (4 * c[0][ii] - 5 * c[4][ii] + c[5][ii] - c[13][ii]
								- c[12][ii] + c[11][ii] - 5 * c[10][ii]
								+ 6 * c[17][ii]);
		...
		Cuuv[ii] = 13.5
				* (-c[0][ii] + 2 * c[4][ii] - c[5][ii] + c[6][ii] + c[9][ii]
						- 2 * c[16][ii]);
		Cvvw[ii] = 13.5
				* (-c[0][ii] + 2 * c[9][ii] - c[8][ii] + c[10][ii] + c[14][ii]
						- 2 * c[19][ii]);
		Cuww[ii] = 13.5
				* (-c[0][ii] + 2 * c[10][ii] - c[11][ii] + c[4][ii] + c[13][ii]
						- 2 * c[17][ii]);

		Cuvv[ii] = 13.5
				* (-c[0][ii] + c[4][ii] - c[8][ii] + c[7][ii] + 2 * c[9][ii]
						- 2 * c[16][ii]);
		Cvww[ii] = 13.5
				* (-c[0][ii] + c[9][ii] - c[11][ii] + c[15][ii] + 2 * c[10][ii]
						- 2 * c[19][ii]);
		Cuuw[ii] = 13.5
				* (-c[0][ii] + c[10][ii] - c[5][ii] + c[12][ii] + 2 * c[4][ii]
						- 2 * c[17][ii]);

		Cuvw[ii] = 27
				* (-c[0][ii] + c[4][ii] + c[9][ii] + c[10][ii] - c[16][ii]
						- c[17][ii] - c[19][ii] + c[18][ii]);
	}
}
